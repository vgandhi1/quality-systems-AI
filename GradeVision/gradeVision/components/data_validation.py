...
from gradeVision.entity.config_entity import DataValidationConfig
from gradeVision.entity.artifacts_entity import DataIngestionArtifact, DataValidationArtifact
